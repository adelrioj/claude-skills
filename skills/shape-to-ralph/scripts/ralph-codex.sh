...
###############################################################################
# ralph-codex.sh — Autonomous coding loop for shape-driven stories (Codex)
#
# Codex-compatible version of ralph.sh. Uses codex CLI with full-auto
# approval mode instead of Claude Code.
#
# Usage:
#   ${CLAUDE_PLUGIN_ROOT}/skills/shape-to-ralph/scripts/ralph-codex.sh
#   ${CLAUDE_PLUGIN_ROOT}/skills/shape-to-ralph/scripts/ralph-codex.sh --max-iterations 5
#   ${CLAUDE_PLUGIN_ROOT}/skills/shape-to-ralph/scripts/ralph-codex.sh --model o3
#   ${CLAUDE_PLUGIN_ROOT}/skills/shape-to-ralph/scripts/ralph-codex.sh --dry-run
#
# Expects tasks/prd.json generated by /shape-to-ralph skill.
###############################################################################
...
if [[ ! -f "$PRD_FILE" ]]; then
  ...
  echo "Run /shape-to-ralph first to generate it."
  exit 1
fi
...
echo "╔═══════════════════════════════════════════════════════════════╗"
echo "║             Ralph Autonomous Loop (Shape — Codex)            ║"
echo "╠═══════════════════════════════════════════════════════════════╣"
printf "║  Project:    %-48s║\n" "$PROJECT_NAME"
printf "║  Branch:     %-48s║\n" "$CURRENT_BRANCH"
