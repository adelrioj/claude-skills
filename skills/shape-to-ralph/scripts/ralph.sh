...
###############################################################################
# ralph-shape.sh — Autonomous coding loop for shape-driven stories
#
# Same loop as ralph.sh but uses ralph-shape-prompt.md, which reads shaping
# artifacts (requirements, affordance tables, wiring) instead of
# implementation plans.
#
# Usage:
#   ${CLAUDE_PLUGIN_ROOT}/skills/shape-to-ralph/scripts/ralph.sh
#   ${CLAUDE_PLUGIN_ROOT}/skills/shape-to-ralph/scripts/ralph.sh --max-iterations 5
#   ${CLAUDE_PLUGIN_ROOT}/skills/shape-to-ralph/scripts/ralph.sh --dry-run
#
...
echo "╔═══════════════════════════════════════════════════════════════╗"
echo "║                Ralph Autonomous Loop (Shape)                 ║"
echo "╠═══════════════════════════════════════════════════════════════╣"
printf "║  Project:    %-48s║\n" "$PROJECT_NAME"
printf "║  Branch:     %-48s║\n" "$CURRENT_BRANCH"
