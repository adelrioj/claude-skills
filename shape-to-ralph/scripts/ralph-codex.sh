...
#
# Usage:
#   .claude/skills/shape-to-ralph/scripts/ralph-codex.sh
#   .claude/skills/shape-to-ralph/scripts/ralph-codex.sh --max-iterations 5
#   .claude/skills/shape-to-ralph/scripts/ralph-codex.sh --model o3
#   .claude/skills/shape-to-ralph/scripts/ralph-codex.sh --dry-run
#
