...
- Swarm workers delegate ALL code-writing to `codex exec --sandbox workspace-write`, foreground only — never `--background`, `--resume-last`, or `--dangerously-bypass-approvals-and-sandbox`
